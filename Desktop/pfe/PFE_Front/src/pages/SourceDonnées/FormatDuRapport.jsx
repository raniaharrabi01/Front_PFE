...
const FormatDuRapport = ({ setShowModal , setSelectedFormat ,générerRapport }) => {

    const handleFormatChange = (format) => {
        setSelectedFormat(format); // Mettre à jour reportFormat dans le composant CSVFile
    };
    return (
        <>
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 pb-2 flex-auto">
                            <div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="input-group mb-3 mt-2">
                                        <input className="form-check-input mr-2" type="radio" name="format" id="html" value="html" onChange={() => handleFormatChange('html')} />
                        ...
                        <div className="flex items-center justify-center p-3">
                            <button
                                ...
                                type="button"
                                onClick={() => { setShowModal(false); générerRapport(); }}
                            >
                                Générer rapport
                            </button>
                        </div>
