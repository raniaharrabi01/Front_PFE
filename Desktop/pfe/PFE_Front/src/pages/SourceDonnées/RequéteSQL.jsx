...
const RequêteSQL = ({DataBaseConnexion}) => {
  ...
  const handleGenerateReport = () => {
    generateReportfromSQLquery(reportFormat,DataBaseConnexion,SQLRequete)
  };
              ...
              <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                ...
                <div className="flex flex-row items-center">
                  <div className="flex justify-center">
                    <button type="button" className="inline-flex items-center justify-center rounded-full bg-primary py-3 px-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-6 mt-4 mr-2" onClick={() => validerSQLRequete()}>Valider</button>
                    {Valide && (
                      <div className="flex justify-center">
