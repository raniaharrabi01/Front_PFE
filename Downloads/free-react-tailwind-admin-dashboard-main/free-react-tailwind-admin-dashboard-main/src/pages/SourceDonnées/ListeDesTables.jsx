...
const ListeDesTables = ({ NomDeLaBase, ListeTablesAndColumns }) => {
  ...
  return (
    <div>
      <h3 className="font-medium text-[#4169E1] dark:text-[#4169E1]" style={{ paddingLeft: '28px', fontWeight: '600' }}> La liste des tables dans la base de données {NomDeLaBase} : </h3>
