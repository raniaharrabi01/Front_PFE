...
const Modéle = () => {
  ...
  const rechercherMedéle = () => {
    fetch('http://localhost:8080/Template/getTemplateData')
      .then(response => {
        if (!response.ok) {
                ...
                <table className="w-full table-auto">
                  ...
                  <tbody>
                   {modelsToRender?.map((model, index) => (
                      <tr key={index}>
                        ...
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <div className="flex items-center space-x-3.5">
                            <button title="ouvrir modéle" className="hover:text-primary">
                              <svg
                    ...
                    <button title="supprimer modéle" className="hover:text-primary" onClick={() =>{supprimer_model(model.name);}}>
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"
